    ...
    for portale in config["portali_attivi"]:
        ...
        try:
            ...
            if seen_ids:
                ...
                print(
                    f"ATTENZIONE: 0 annunci estratti da {portale}, salto la rimozione "
                    "(probabile problema di parsing, non di disponibilita' reale)"
                )
        except Exception as e:
            print(f"errore durante lo scraping di {portale}: {e}")
            continue
